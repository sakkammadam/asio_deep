...
std::string standard_message(){
    ...
    if(strcmp(process_msg,"MAPPER COMPLETE!")==0){
        ...
        switch (randomNumber) {
            case 0:
                msg = "Server says very Good!\n";
                break;
            case 1:
                msg = "Server says excellent!\n";
                break;
            case 2:
                msg = "Server says nice work!\n";
                break;
            case 3:
                msg = "Server says keep up the good work!\n";
                break;
            default:
                msg = "Server says You are doing great!!\n";
        }
    }
    return msg;
}
...
int main() {
    ...
    while(heartbeat_dispatch){
        ...
        while(strcmp(process_msg,"MAPPER COMPLETE!")!=0 && count== 0){
            mapper_results = mapperOperation("/home/sakkammadam/Documents/syr/cse687/projects/input_files/phase4_qa");
